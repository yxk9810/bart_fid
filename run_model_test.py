...
def test_model_generation():
    ...
    test_dataset = TextDataset(eval_dataset, tokenizer, max_encoding_length=args.max_encoding_length, max_decoding_length=args.max_decoding_length, max_ref_num=args.max_ref_num)
